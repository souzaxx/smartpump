...
// all occurrences of "Serial3" to "Serial1" or "Serial2" in the code below.
	...
	if (Serial3.available()) // is there something to check?
	{
		...
		while (Serial3.available())
		{
			...
			else
			{
				...
				//Serial.print("Characters Value... ");
				//Serial.println(frame[buffer],HEX);
